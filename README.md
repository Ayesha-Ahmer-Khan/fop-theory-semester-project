# fop-theory-semester-project
my fundamentals of computer programming end semester project made in C++
#include <iostream>
#include <string>
using namespace std;
...
//study log
void logStudyHours(int study[7][3]){
    cout<<"Log Study Hours (Mon-Sun, 3 sessions)"<<endl;
    for(int i=0; i<7; i++){
        cout<<"Day "<<i+1<<":"<<endl;
        for(int j=0; j<3; j++){
            cout<<"  Session "<<j+1<<": ";
...
void showStudyReport(int study[7][3]) {
    ...
    for(int i=0; i<7; i++){
        ...
        cout<<"Day "<<i+1<<" total: "<<total<<" hours"<<endl;
    }
}
